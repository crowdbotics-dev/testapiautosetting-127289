...
## Project Structure
    ...
    ├── testapiautosetting_127289  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127289`
...
2. Clone this repo and `cd testapiautosetting_127289`
